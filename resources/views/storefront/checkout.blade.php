...
<div class="dashboard-hero">
    <div><div class="dashboard-kicker">Secure checkout</div><h1 class="dashboard-title">Complete your order</h1><p class="dashboard-subtitle">Enter your delivery details and review your purchase.</p></div>
</div>
...
<div class="checkout-grid">
    <form method="POST" action="{{ route('checkout.store') }}" class="dashboard-panel checkout-form">
        ...
        <label>Phone number<input name="customer_phone" value="{{ old('customer_phone') }}" placeholder="07XXXXXXXX" required></label>
        <label>Delivery address<textarea name="delivery_address" rows="4" placeholder="House/building, area, town/city" required>{{ old('delivery_address') }}</textarea></label>
